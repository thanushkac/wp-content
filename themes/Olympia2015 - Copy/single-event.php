...
yoast_breadcrumb('<p id="breadcrumbs">','</p>');
		...
		<?php while ( have_posts() ) : the_post(); ?>
			...
			<div class="entry-content">
                ...
                <div class="col-md-4">
                <?php if ( is_active_sidebar( 'eventform' ) ) : ?>
	<div class="widget-area" role="complementary">
		<?php dynamic_sidebar( 'eventform' ); ?>
	</div>
	<?php endif; ?>
                </div>
                </div>
			...
			<?php
				...
				if ( '' != $categories_list ) {
					...
					$utility_text = __( 'This event was posted by <a href="%5$s">%4$s</a>. | Bookmark this <a href="%2$s" title="Permalink to %3$s" rel="bookmark">page</a>.', 'eventorganiser' );
				}
				printf($utility_text,
					$categories_list,
			...
			<div class="comments-template text-left">
