...
<div id="primary" class="site-content">
	...
	<header class="page-header">	
		...
		<h3 class="page-title"><?php printf( __( 'Events at: %s', 'eventorganiser' ), '<span>' .eo_get_venue_name($venue_id). '</span>' );?></h3>
	...
	<?php else : ?>
			...
			<article id="post-0" class="post no-results not-found">
				<header class="entry-header">
					<h4 class="entry-title"><?php _e( 'Nothing Found', 'eventorganiser' ); ?></h4>
				</header><!-- .entry-header -->
