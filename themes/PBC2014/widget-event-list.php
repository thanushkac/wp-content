...
$classes = $eo_event_loop_args['events-home'];
...
<?php if( $eo_event_loop->have_posts() ): ?>
	...
	<div <?php echo $id; ?> class="<?php echo esc_attr($classes);?>" > 
		...
		<?php while( $eo_event_loop->have_posts() ): $eo_event_loop->the_post(); ?>
			...
			<p class="<?php echo esc_attr(implode(' ',$eo_event_classes)); ?>" >
				<a href="<?php the_permalink(); ?>" title="<?php the_title_attribute(); ?>" ><?php the_title(); ?></a> <br/> <?php echo __('on','eventorganiser') . ' '.eo_get_the_start($format); ?>
			</p>
 <div class="hr"></div>
		<?php endwhile; ?>
