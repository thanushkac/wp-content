...
<div class="navbar-right visible-lg visible-md parentsright">
    ...
    <a class="orangetxt" href="http://www.americaadopts.com/adoption-profiles/">BACK TO ADOPTION PROFILES</a>
  </div>
          </div>
...
<li><a class="orangenav" href="<?php echo get_permalink($post->ID); ?>"> LETTER</a> </li>
              ...
              <li class="visible-sm visible-xs"><a class="orangenav" href="http://www.americaadopts.com/adoption-profiles/">BACK TO ADOPTION PROFILES</a></li> 
</ul>
