...
//googlefonts
function load_fonts() {
            wp_register_style('googleFonts', 'http://fonts.googleapis.com/css?family=Source+Sans+Pro:300,400,600,700');
...
function twentyfourteen_widgets_init() {
	...
	register_sidebar( array(
		'name'          => __( 'Social Sidebar', 'twentyfourteen' ),
		'id'            => 'sidebar-4',
		'description'   => __( 'Appears in common sidebar', 'twentyfourteen' ),
		'before_widget' => '<aside id="%1$s" class="widget %2$s">',
		'after_widget'  => '</aside>',
		'before_title'  => '<h1 class="widget-title">',
		'after_title'   => '</h1>',
