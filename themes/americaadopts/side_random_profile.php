...
<div>
	...
	<div class="sideRandomProfileTitle">Featured Hopeful Parent<?php if($isSingleParent == 'False') echo "s";?></div>
	<div class="sideRandomProfileName text-center"><a href="<?php echo $randomPageLink; ?>"><?php echo 'Meet ' . $partner1FirstName; if($isSingleParent == 'False') {echo ' and ' . $partner2FirstName; } echo ' from ' . $familyState . '.'; ?></a></div>
