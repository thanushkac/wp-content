...
<a class="navbar-brand" href="<?php echo home_url(); ?>">
        ...
        <div class="nav navbar-nav navbar-right orangetxt">
            <a class="orangetxt" href="<?php bloginfo('template_url'); ?>/blog/">Blog</a> &nbsp; | &nbsp;
...
<div class="navbar-right searchbg visible-lg visible-md">
    ...
    <form id="searchformheader" method="get" action="<?php echo $_SERVER['PHP_SELF']; ?>">
      <input type="text" value="SEARCH >>" name="s" class="searchboxHome" onfocus="if (this.value == 'SEARCH >>') {this.value = '';}" onblur="if (this.value == '') {this.value = 'SEARCH >>';}"/>
