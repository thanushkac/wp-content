...
<div id="checkout_page_container">
	...
	<header>
		...
		<a href="<?php echo get_option("product_list_url"); ?>" class="shopping-page" title="Continue Shopping">Continue Shopping</a>
            ...
            <?php
               ...
               "<div class='wpsc_email_address'>
                  <p class='" . wpsc_checkout_form_element_id() . "'>
                     ...
                     " . __('Enter your email address', 'tokokoo') . "
                     </label>
	...
	<div class='wpsc_make_purchase'>
         <span>
            ...
            <?php endif; ?>
               ...
               <input type='submit' value='<?php _e('Purchase', 'tokokoo');?>' name='submit' class='make_purchase wpsc_buy_button' />
         </span>
	</div>
