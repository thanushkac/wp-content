...
$formRegion = mysql_real_escape_string($_REQUEST["province"]);
...
if (!empty($formRegion) && $formRegion != '0') {
  $query .= "
left join " . $db_prefix . "postmeta pm6 on p.ID = pm6.post_id and pm6.meta_key = 'state'";
}
...
if (!empty($formRegion) && $formRegion != '0') {
  $query .= "
and (pm6.meta_key = 'state' and pm6.meta_value = '$formRegion')";
}
    ...
    <div class="row">
      <div class="col-md-12">
        ...
        <form class="form-inline" role="form">
          ...
          <div class="form-group">
            <label class="control-label col-md-3 searchlabels" for="exampleInputEmail2">Province</label>

            <div class="col-md-9">
              <select name="province" size="1" class="form-control">
          ...
          <div class="form-group">
            ...
            <button type="reset" class="btn btn-default btn-xs" onclick="clearSearch();">Clear</button>
          </div>
        </form>
...
<span class="pageViewButton2">
  ...
  <script type="text/javascript">
    ...
    if (region != '0' && region != '') {
      jQuery(':input[name=province]').val(region);
    }

    function clearSearch() {
      jQuery(':input[name=ethnicity]').val(0);
      jQuery(':input[name=religion]').val(0);
      jQuery(':input[name=province]').val(0);
      return false;
    }
  </script>
