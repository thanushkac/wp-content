...
<?php
			...
			if (!empty($agencyAttorneyInformation)) {
				echo "Licensee Contact Info: " . $agencyAttorneyInformation . "<br/>";
			}
...
<?php
	...
	$bcc = "BCC: lawrence@canadaadopts.com";
	...
	if ($formName != "" && $formEmail != "" && $formMessage != "") {
		...
		wp_mail($couplePrivateEmail, '[CANADA-ADOPTS] Contact Form Submission', $emailMessage, $headers);
	} else {
